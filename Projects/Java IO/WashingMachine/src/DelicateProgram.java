...
public class DelicateProgram implements Program {
    ...
    public DelicateProgram(Prompt prompt) {
        this.prompt = prompt;
    }
    ...
    StringInputPrompt stringInputPrompt = new StringInputPrompt("Delicate program chosen check the clothing label before wash, write what you want to wash separated by white spaces.");
    ...
    public void checkTime() throws IOException {
        DoubleRangeInputPrompt testDoubleRange = new DoubleRangeInputPrompt("Choose the amount of time between 1.0 and 3.0 hours.", 1.0, 3.0);
   ...
   @Override
    public void checkTemperature() throws IOException {
        ...
        IntegerRangeInputPrompt testIntRange = new IntegerRangeInputPrompt("Write the temperature you want pick between 20 and 50 degrees.", 20, 50);
